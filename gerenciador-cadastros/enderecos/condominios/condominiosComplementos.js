(function(){
    ...
    CondominiosComplementosCtrl.$inject = ['arrecadacao.common.GridConfig','$scope', 'CondominiosService', 'arrecadacao.common.ModalCad', 'bfc.Notification', 'promiseTracker', '$timeout', 'UNDO_TIMEOUT'];

    function CondominiosComplementosCtrl(GridConfig, $scope, CondominiosService, ModalCad, Notification, promiseTracker, $timeout, UNDO_TIMEOUT){
        ...
        function carregarRegistros() {
            var promise = CondominiosService.findBy(vm.gridConfig.buildFilter());
        ...
        function removerRegistro(registro){
            CondominiosService.remove(registro).then(function(){
        ...
        function abrirPopup(resolve){
            ModalCad.open({
                ...
                controller: 'CondominiosComplementosCtrl as CondominiosComplementosCtrl',
                scope: $scope,
    ...
    CondominiosComplementosCtrl.$inject = ['arrecadacao.common.ContribuintesSelect', 'arrecadacao.common.LogradouroSelect','arrecadacao.common.BairrosSelect','$scope', 'bfc.Focus', 'CondominiosComplementosService', 'bfc.Notification', 'promiseTracker', '$q', 'UNDO_TIMEOUT', '$modalInstance', 'params','$timeout'];

    function CondominiosComplementosCtrl(ContribuintesSelect, LogradouroSelect, BairrosSelect, $scope, Focus, CondominiosComplementosService, Notification, promiseTracker, $q, UNDO_TIMEOUT, $modalInstance, params, $timeout){
        ...
        vm.salvar = function(continuarCadastro) {
            ...
            var promiseSave = CondominiosComplementosService.save(vm.registro).then(function(data) {
